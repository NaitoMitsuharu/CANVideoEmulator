...
public sealed class RecentCanMonitor
{
    ...
    /// </summary>
    /// <remarks>
    /// A fixed, scroll-free list. The stream runs at ~1,100 frames per second,
    /// so anything below the fold is replaced faster than it can be read and a
    /// scrollbar only invites a reader to chase it. Twelve rows is what fits the
    /// panel without pushing the timing figures off screen.
    /// </remarks>
    public const int DisplayRows = 12;
