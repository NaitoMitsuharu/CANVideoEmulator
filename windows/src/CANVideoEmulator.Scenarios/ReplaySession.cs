...
public sealed class ReplaySessionOptions
{
    ...
    /// </summary>
    /// <remarks>
    /// There is no back-channel from Windows to the receiver -- the only link is
    /// the CAN bus itself, and requirement 2 forbids inventing control frames. So
    /// a scenario change is signalled by the absence of traffic: a compatible receiver
...
public sealed class ReplaySession : IAsyncDisposable
{
    ...
    public void SelectBus(int bus)
    {
        ...
        // receiver forget the previous bus's signals.
